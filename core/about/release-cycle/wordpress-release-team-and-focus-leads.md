...
*   この役割は、製品とリリースという2つの主要な領域に分かれています。
    ...
    *   「リリース」領域には、リリース固有の資料 (About ページなど) の調整が含まれます。
*   デザインに関するインプットが必要なコアエディターおよびブロックエディターのチケットについて、ガイダンスと意思決定を提供します。
*   様々なリリースアセットのデザインとコピーを調整します。
    *   各 WordPress リリースのハイライトグリッドとマイクロサイトの作成をガイドします。これには、各メジャーリリースに同梱され、wp-admin に表示される独自の About ページも含まれます。参考までに、過去のハイライトグリッドの例を以下に示します。
...
*   リリースチームの残りのメンバーと次の点についてコミュニケーションをとる:
    ...
    *   マーケティングチームと About ページ向けに重要な機能と更新内容をハイライトする
    *   他のリーダーと連携する
